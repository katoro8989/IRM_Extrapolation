...
from datasets.domainbed_dataset import WILDSCamelyon

class Camelyon_FROM_DOMAINBED:
    ...
    def data_loaders(self, **kwargs):
        ...
        camelyon_class = WILDSCamelyon(self.flags.data_dir, test_envs, hparams)

        self.train_loader = []
        for i, env_set in enumerate(camelyon_class):
